...
\newcommand{\sectionnn}[1]{\section*{#1}\addcontentsline{toc}{section}{#1}\setcounter{subsection}{0}}
\newcommand{\subsectionnn}[1]{\subsection*{#1}\addcontentsline{toc}{subsection}{#1}\setcounter{subsubsection}{0}}
